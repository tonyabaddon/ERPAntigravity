-- supabase/migrations/20260630000003_create_tempo_invoice_allow_negative_stock.sql
-- Add allow_negative_stock payload key support to create_tempo_invoice RPC.
