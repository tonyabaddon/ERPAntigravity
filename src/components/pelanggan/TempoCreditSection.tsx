...
export default function TempoCreditSection({ customer, onChanged, showToast }: Props) {
    ...
    return (
      <div className="bg-slate-50 rounded p-4">
        ...
        <button onClick={handleRequestActivate} disabled={submitting}
          className="w-full bg-channel-grosir text-white py-2.5 rounded text-sm font-semibold disabled:opacity-50">
  ...
  return (
    <div className="bg-secondary/5 rounded p-4 border border-secondary/20">
      <div className="flex items-center justify-between mb-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button onClick={handleRequestChange} disabled={submitting}
          className="bg-white border border-slate-300 text-slate-700 py-2 rounded text-sm font-medium hover:bg-slate-50 disabled:opacity-50">
          ✏️ Ubah Limit
        </button>
