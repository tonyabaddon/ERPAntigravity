  ...
  if (error) {
    return (
      <div>
        ...
        <select
          disabled
          className="w-full border border-rose-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-caleo-primary)]/30 bg-white disabled:opacity-60"
        >
