  ...
  if (error) {
    return (
      <div>
        ...
        <select
          disabled
          className="w-full border border-rose-300 rounded px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold bg-white disabled:opacity-60"
        >
