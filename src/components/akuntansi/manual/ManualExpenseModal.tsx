      ...
      <div className="bg-white rounded-3xl max-w-2xl w-full shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        >
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-orange-200 text-orange-700">
          ...
          <button
            ...
            className="text-orange-500 hover:text-orange-700 p-1 rounded-lg hover:bg-white/60"
            disabled={saving}
            aria-label="Tutup"
          >
            <X className="w-5 h-5" />
        ...
        <div className="p-6 space-y-3 text-[13px]">
          ...
          {/* Fetch error */}
          {fetchError && (
            <div className="border border-orange-200 bg-orange-50 rounded-xl p-3 text-[12px] text-orange-700">
              ⚠ {fetchError}
            </div>
          )}
          ...
          <div>
            ...
            <select
              ...
              disabled={saving}
              className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-300/50 bg-white disabled:opacity-60"
            >
          ...
          <div>
            ...
            <input
              ...
              placeholder="Rp 0"
              disabled={saving}
              className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm text-right font-bold focus:outline-none focus:ring-2 focus:ring-orange-300/50 disabled:opacity-60"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={saving}
              className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-300/50 disabled:opacity-60"
            />
            {isFuture && (
          ...
          <div>
            ...
            <div
              className="border-2 border-slate-200 rounded-xl px-3 py-3 text-center text-[12px] text-gray-500 flex flex-col items-center gap-1"
