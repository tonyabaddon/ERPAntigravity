      ...
      <div className="bg-white rounded max-w-2xl w-full shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-3 text-[13px]">
          ...
          <div>
            ...
            <div className="border border-rose-200 bg-rose-50 rounded px-3 py-2 text-[12px]">
          ...
          <div>
            ...
            <select
              ...
              disabled={saving}
              className="w-full border border-slate-200 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-300/50 bg-white disabled:opacity-60"
            >
          ...
          <div>
            ...
            <input
              ...
              placeholder="Rp 0"
              disabled={saving}
              className="w-full border border-slate-200 rounded px-3 py-2 text-sm text-right font-bold focus:outline-none focus:ring-2 focus:ring-rose-300/50 disabled:opacity-60"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={saving}
              className="w-full border border-slate-200 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-300/50 disabled:opacity-60"
            />
            {isFuture && (
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-slate-200 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-300/50 disabled:opacity-60 resize-none"
            />
          </div>
