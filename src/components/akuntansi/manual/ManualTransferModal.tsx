      ...
      <div className="bg-white rounded-3xl max-w-2xl w-full shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        >
          <div className="flex items-start gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${cfg.iconTileCls}`}>
        ...
        <div className="p-6 space-y-4 text-[13px]">
          ...
          <div>
            ...
            <div
              className="border border-[#c7d7f5] bg-[#fafbff] rounded-xl p-4 text-center text-[12px] text-gray-500"
