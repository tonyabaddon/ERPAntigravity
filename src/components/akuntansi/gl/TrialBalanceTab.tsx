    ...
    <div className="rounded-3xl border border-[#c7d7f5] bg-white overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-200 flex items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {/* Period selector */}
          <select
            className="border border-[#c7d7f5] rounded-lg px-3 py-1.5 text-xs text-[#43474e] bg-white w-44 focus:outline-none focus:ring-2 focus:ring-[#c7d7f5]"
          ...
          {/* Export placeholders */}
          <button
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#c7d7f5] bg-white text-xs text-[#43474e] font-medium hover:bg-[#f5f7ff] transition-colors"
      ...
      {!loading && rows.length > 0 && (
        <div
          className="mx-6 mt-6 rounded-xl border p-3 flex items-center gap-3"
          style={
            isBalanced
