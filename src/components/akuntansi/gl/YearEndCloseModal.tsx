    ...
    >
      <div className="bg-white rounded-3xl max-w-2xl w-full shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-4 text-[13px]">
          ...
          {loading && (
            <div className="border border-[#c7d7f5] bg-[#fafbff] rounded-xl p-6 text-center text-[13px] text-gray-500">
              Memuat snapshot...
            </div>
          )}
          ...
          {!loading && snapshot && (
            <>
              ...
              {/* Snapshot */}
              <div className="border border-[#c7d7f5] bg-[#fafbff] rounded-xl p-4 space-y-2">
              ...
              {/* JE preview */}
              <div className="rounded-xl p-3 border" style={{ background: '#fef3c7', borderColor: '#fbbf24' }}>
