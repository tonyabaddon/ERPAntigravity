...
export default function COAManagementTab({
  ...
  return (
    <div className="rounded border border-[var(--color-caleo-mist-dark)] bg-white overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-200">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <input
            ...
            className="flex-1 min-w-[200px] border border-[var(--color-caleo-mist-dark)] rounded px-3 py-1.5 text-xs text-[#43474e] bg-white placeholder-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2"
            value={searchQuery}
      ...
      {/* ── Non-owner banner ── */}
      {!isOwner && (
        <div className="mx-6 mt-4 rounded border border-gray-300 bg-gray-50 p-3 text-xs text-gray-700">
                    ...
                    {typeRows.map(account => {
                      ...
                      return (
                        ...
                        >
                          {/* Left: code + indent */}
                          <div
                            className={`font-mono text-caleo-13 font-bold text-[var(--color-caleo-primary)] whitespace-nowrap ${
                          ...
                          <div className="flex-1 min-w-0">
                            <div
                              className={`text-caleo-13 flex items-center gap-2 ${
                                isInactive
                                  ? 'text-gray-500'
                                  : 'text-[#43474e]'
                              }`}
