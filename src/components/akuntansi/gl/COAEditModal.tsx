  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
        <div
          className="bg-white rounded shadow-lg max-w-md w-full mx-4 pointer-events-auto"
        ...
        >
          ...
          <div className="p-6 border-b border-gray-200 flex items-start justify-between gap-3">
            ...
            <button
              className="p-1 rounded hover:bg-gray-100 transition-colors text-gray-600 shrink-0"
              onClick={onClose}
            >
              <X className="w-5 h-5" />
            </button>
