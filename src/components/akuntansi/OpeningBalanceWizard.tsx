  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="w-10 h-10 rounded bg-[var(--color-caleo-cloud)] flex items-center justify-center text-[var(--color-caleo-primary)]">
      ...
      {step === 1 && (
        <div className="border border-[var(--color-caleo-mist-dark)] bg-[#fafbff] rounded p-6">
          ...
          <input
            ...
            className="border border-slate-200 rounded px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold w-full max-w-xs"
          />
                  ...
                  <tr key={a.account_code} className="border-b border-[var(--color-caleo-mist)] hover:bg-white/60 transition-colors">
                    ...
                    <td className="py-2.5 text-right">
                      <NumberInput
                        ...
                        className="border border-slate-200 rounded px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold w-36 text-right font-bold"
                      />
                    </td>
                  </tr>
                ))}
