...
export default function PromoInlineEdit({
  ...
  return (
    <div
      ref={popoverRef}
      className="absolute z-20 left-0 top-full mt-1 bg-white border border-slate-200 rounded shadow-xl w-72 p-4 space-y-3"
    ...
    >
      ...
      <div className="flex gap-2 pt-1">
        <button
          ...
          onClick={handleSave}
          className="flex-1 py-1.5 bg-blue-600 text-white text-xs font-bold rounded hover:bg-blue-700 disabled:opacity-50"
        >
