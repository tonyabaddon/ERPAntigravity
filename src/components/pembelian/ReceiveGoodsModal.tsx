        ...
        <div className="px-4 py-4 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input type="date" value={receivedAt} onChange={e => setReceivedAt(e.target.value)} className="w-full text-sm border border-gray-200 rounded-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300" />
            </div>
            <div>
              ...
              <input type="date" value={paymentDueAt} onChange={e => setPaymentDueAt(e.target.value)} className="w-full text-sm border border-gray-200 rounded-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300" />
                    ...
                    <div className="grid grid-cols-12 px-3 py-2.5 items-center border-b border-gray-100">
                      ...
                      <div className="col-span-2 flex justify-center">
                        <input
                          ...
                          className="w-14 text-center text-sm border border-emerald-300 rounded-sm px-2 py-1 bg-emerald-50 focus:outline-none focus:ring-1 focus:ring-emerald-400"
                        />
                      </div>
                      <div className="col-span-2 flex justify-center">
                        <input
                          ...
                          className={`w-14 text-center text-sm border rounded-sm px-2 py-1 focus:outline-none focus:ring-1 ${hasDamage ? 'border-rose-300 text-rose-700 font-bold bg-white focus:ring-rose-400' : 'border-gray-200 focus:ring-indigo-300'}`}
                        />
                      </div>
                      <div className="col-span-3 pl-2">
                        {hasDamage ? (
                          <input
                            ...
                            className="w-full text-xs border border-rose-200 rounded-sm px-2 py-1 focus:outline-none focus:ring-1 focus:ring-rose-300 placeholder-rose-300"
