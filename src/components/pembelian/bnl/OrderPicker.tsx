...
export default function OrderPicker({ value, onChange }: OrderPickerProps) {
  ...
  if (value) {
    return (
      <div className="border-2 border-indigo-300 bg-indigo-50/40 rounded p-3">
  ...
  return (
    <div className="relative">
      ...
      {open && results.length > 0 && (
        <div className="absolute z-30 left-0 right-0 mt-1 max-h-64 overflow-auto bg-white rounded border border-gray-200 shadow-lg">
          {results.map(r => (
