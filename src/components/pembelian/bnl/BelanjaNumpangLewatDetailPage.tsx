      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          {pi.status === 'BELUM_LUNAS' && !pi.voided_at && (
            <>
              <button onClick={() => setShowPay(true)} className="inline-flex items-center gap-2 text-sm font-semibold text-white bg-green-600 px-3 py-2 rounded hover:bg-green-700">
                <CheckCircle className="w-4 h-4" /> Tandai Lunas
              </button>
              <button onClick={() => onEdit(pi)} className="text-sm font-semibold text-gray-700 px-3 py-2 rounded border border-gray-200 hover:bg-gray-50">Edit</button>
            </>
          )}
          ...
          <button onClick={handlePrintPdf} className="inline-flex items-center gap-2 text-sm font-semibold text-gray-700 px-3 py-2 rounded border border-gray-200 hover:bg-gray-50">
