    ...
    <div className="grid grid-cols-12 px-4 py-3 border-b border-gray-100 items-center hover:bg-gray-50">
      ...
      <div className="col-span-2 flex justify-center">
        <input
          ...
          className="w-16 text-center text-sm font-semibold border border-gray-200 rounded px-2 py-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2"
        />
      </div>
      <div className="col-span-2 flex justify-end">
        <div className="relative w-32">
          ...
          <input
            ...
            placeholder="0"
            className="w-full text-right text-sm border border-gray-200 rounded pl-7 pr-2 py-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2"
          />
        </div>
      </div>
