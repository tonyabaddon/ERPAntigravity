      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            className="w-full text-sm border border-gray-200 rounded px-3 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold bg-white placeholder-gray-400"
          />
          {prefillName && (
        ...
        <div>
          ...
          <input
            ...
            className="w-full text-sm border border-gray-200 rounded px-3 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold bg-white"
          />
