    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 flex-wrap">
          <button
            onClick={handlePrint}
            disabled={printing}
            className="inline-flex items-center gap-2 text-sm font-semibold text-gray-700 px-3 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 disabled:opacity-50"
          >
          ...
          {!isVoided && (
            <button
              ...
              className="text-sm font-semibold text-gray-700 px-3 py-2 rounded-lg border border-gray-200 hover:bg-gray-50"
            >
              Edit Header
            </button>
          )}
          {canDelete && (
            <button
              ...
              className="inline-flex items-center gap-2 text-sm font-semibold text-red-700 px-3 py-2 rounded-lg border border-red-200 hover:bg-red-50"
            >
      ...
      <div className="bg-white/78 backdrop-blur-xl rounded-3xl border border-gray-200 shadow-sm p-5">
        ...
        {(!tf.tagihans || tf.tagihans.length === 0) ? (
          <div className="p-6 text-center text-sm text-gray-400 border border-dashed border-gray-200 rounded-2xl">
      ...
      <details className="bg-white/78 backdrop-blur-xl rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      ...
      >
        ...
        <div className="flex justify-end gap-2 px-5 py-3 border-t border-gray-200">
          <button
            onClick={onClose}
            className="text-sm font-medium text-gray-600 px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50"
          >
            Batal
          </button>
          <button
...
function DeleteTfModal({ tf, showToast, onClose, onDeleted }: DeleteProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      <div
        className="bg-white rounded-xl border border-red-200 shadow-xl w-full max-w-md"
        onClick={e => e.stopPropagation()}
      >
        ...
        <div className="flex justify-end gap-2 px-5 py-3 border-t border-gray-200">
          ...
          <button
            ...
            className="text-sm font-semibold text-white bg-red-600 px-4 py-2 rounded-lg hover:bg-red-700 disabled:opacity-50"
          >
