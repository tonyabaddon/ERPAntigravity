    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        >
          ...
          <div className="text-caleo-11 text-gray-600 mt-1">
      ...
      {tf.notes && (
        <div className="bg-white/78 backdrop-blur-xl rounded border border-gray-200 shadow-sm p-4">
          <div className="text-caleo-11 font-bold uppercase tracking-wide text-gray-500 mb-1">
            Catatan
          </div>
        ...
        {(!tf.tagihans || tf.tagihans.length === 0) ? (
          ...
          <table className="w-full">
            <thead className="border-b border-gray-200">
              <tr>
                <th className="text-left py-2 text-caleo-11 font-semibold text-gray-500 uppercase">
                  Faktur
                </th>
                <th className="text-center py-2 w-24 text-caleo-11 font-semibold text-gray-500 uppercase">
                  Tgl
                </th>
                <th className="text-center py-2 w-44 text-caleo-11 font-semibold text-gray-500 uppercase">
                  JT (asli → bundle)
                </th>
                <th className="text-right py-2 w-32 text-caleo-11 font-semibold text-gray-500 uppercase">
                  Nominal
                </th>
                <th className="text-right py-2 w-32 text-caleo-11 font-semibold text-gray-500 uppercase">
                  Dibayar
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white/78 backdrop-blur-xl rounded border border-gray-200 shadow-sm p-4">
          <div className="text-caleo-11 font-bold uppercase tracking-wide text-gray-500 mb-2">
            Lampiran Foto
          </div>
      ...
      <details className="bg-white/78 backdrop-blur-xl rounded border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="px-4 pb-5 pt-2 bg-gray-50 border-t border-gray-200">
          <pre className="font-mono text-caleo-10 leading-tight whitespace-pre overflow-auto text-gray-700">
