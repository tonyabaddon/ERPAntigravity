    ...
    <div className="space-y-4">
      ...
      {isVoided && (
        <div className="bg-red-50 border border-red-200 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-red-600 mt-1">Void {fmtDate(pesanan.voided_at)}</div>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-indigo-50 rounded-3xl border border-indigo-200 p-4">
          ...
          <div className="text-xl font-extrabold text-indigo-700">{fmtRp(pesanan.total)}</div>
          <div className="text-[11px] text-gray-500 mt-1">Subtotal {fmtRp(pesanan.subtotal)} + Pajak {fmtRp(pesanan.tax_amount)}</div>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead className="border-b border-gray-200">
            <tr>
              ...
              <th className="text-center py-2 w-24 text-[11px] font-semibold text-gray-500 uppercase">Dipesan</th>
              <th className="text-center py-2 w-32 text-[11px] font-semibold text-gray-500 uppercase">Diterima</th>
          ...
          <tfoot>
            <tr>
              ...
              <td className="py-3 text-right text-xl font-extrabold" style={{ color: '#012749' }}>{fmtRp(pesanan.total)}</td>
            </tr>
          </tfoot>
        </table>
      </div>
