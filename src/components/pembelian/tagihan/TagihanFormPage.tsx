    ...
    <tr key={it.pesanan_item_id} className="border-b border-gray-100">
      ...
      <td className="py-3">
        ...
        <NumberInput
          ...
          className="w-full text-sm text-right py-1 px-2 rounded border border-gray-200" />
      </td>
      {modulOn && (
        <td className="py-3">
          <DiscountInlineInput
      ...
      <td className="py-3">
        <select value={it.warehouse_id}
          ...
          className="w-full text-xs py-1 px-2 rounded border border-gray-200">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white/78 backdrop-blur-xl rounded border border-gray-200 shadow-sm p-5">
        ...
        {pesanan ? (
          <div className="border-2 border-indigo-200 bg-indigo-50/40 rounded p-4 flex items-start justify-between">
            <div>
        ...
        <div className="bg-white/78 backdrop-blur-xl rounded border border-gray-200 shadow-sm p-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {initialStatus === 'BELUM_LUNAS' && (
              <div className="col-span-2 p-3 rounded border border-fuchsia-200 bg-fuchsia-50/40">
