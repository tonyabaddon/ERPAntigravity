        ...
        <div className="flex gap-2">
          ...
          {tgh.status === 'BELUM_LUNAS' && !tgh.tukar_faktur_id && !isVoided && (
            <button
              ...
              className="inline-flex items-center gap-1 text-sm font-semibold text-amber-700 px-3 py-2 rounded border border-amber-300 bg-amber-50 hover:bg-amber-100"
            >
          ...
          {tgh.tukar_faktur_id && tfNumber && (
            <button
              ...
              className="inline-flex items-center gap-1 text-xs font-semibold text-amber-700 px-2.5 py-2 rounded border border-amber-200 bg-amber-50 hover:bg-amber-100"
          ...
          {canPay && onOpenPembayaran && (
            <button onClick={() => onOpenPembayaran(tgh.supplier_id)}
              className="inline-flex items-center gap-2 text-sm font-semibold text-white bg-green-600 px-3 py-2 rounded hover:bg-green-700">
