...
export default function PurchaseOrderFormPage({
  ...
  return (
    <div className="space-y-5">
      {/* Sub-page header */}
      <div className="bg-white border border-gray-200 rounded px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={handleBack}
            className="flex items-center gap-1.5 text-sm font-semibold text-gray-600 hover:text-indigo-600 -ml-2 px-2 py-1 rounded hover:bg-gray-50"
          >
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-4">
            ...
            <input
              ...
              className="w-full text-sm border border-gray-200 rounded px-3 py-2.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2 placeholder-gray-400"
            />
          </div>
        </div>
      </section>
      ...
      <div className="bg-white border border-gray-200 rounded px-6 py-4 flex items-center justify-between sticky bottom-0 shadow-lg shadow-gray-200/40">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={saving}
            className="text-sm font-semibold text-gray-700 px-4 py-2 rounded border border-gray-300 hover:bg-gray-100 disabled:opacity-50"
          >
            Simpan Draft
          </button>
          <button
            ...
            disabled={saving}
            className="text-sm font-semibold text-white bg-indigo-600 px-4 py-2 rounded hover:bg-indigo-700 shadow-sm shadow-indigo-200 disabled:opacity-50"
          >
