  ...
  return (
    <div className="relative">
      <select
        ...
        disabled={props.disabled}
        className="appearance-none bg-white border border-slate-200 rounded-sm px-3 py-1.5 pr-8 text-[11px] font-extrabold text-slate-700 outline-none focus:ring-1 focus:ring-[#012749] disabled:opacity-50"
      >
