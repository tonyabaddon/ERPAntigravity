      ...
      <section className="relative w-full md:w-1/2 bg-gradient-to-br from-[#1e3d60] to-[#102a43] overflow-hidden flex flex-col p-12 justify-between">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#2d8a4e] rounded flex items-center justify-center shadow-lg shadow-[#2d8a4e]/30">
        ...
        <div className="relative z-10 flex flex-col items-center text-center space-y-10 py-12">
          <div className="flex items-center justify-center gap-6">
            <div className="w-20 h-20 rounded bg-white/10 backdrop-blur-md border border-white/20 flex flex-col items-center justify-center shadow-2xl skew-y-3 rotate-[-6deg]">
            ...
            <div className="w-20 h-20 rounded bg-white/10 backdrop-blur-md border border-white/20 flex flex-col items-center justify-center shadow-2xl rotate-[6deg]">
