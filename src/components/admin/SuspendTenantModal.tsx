        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full border border-caleo-navy/30 rounded px-3 py-2 text-[13px] text-caleo-navy placeholder:text-caleo-navy/30 resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-danger disabled:opacity-50"
