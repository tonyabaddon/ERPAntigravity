...
export function PaymentInstructionBlock({ tenant }: Props) {
  ...
  if (!settings || !plan) {
    return (
      <div
        className="p-4 rounded text-caleo-13 animate-pulse"
  ...
  return (
    ...
    >
      ...
      <pre
        className="font-mono text-xs whitespace-pre-wrap rounded p-3"
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex-1 py-2 rounded text-caleo-13 font-bold"
        ...
        <a
          ...
          className="flex-1 py-2 rounded text-caleo-13 font-bold text-center"
      ...
      <p className="text-caleo-11" style={{ color: C.muted }}>
