...
export function PaymentInstructionBlock({ tenant }: Props) {
  ...
  if (!settings || !plan) {
    return (
      <div
        className="p-4 rounded text-[13px] animate-pulse"
  ...
  return (
    ...
    >
      ...
      <pre
        className="font-mono text-[12px] whitespace-pre-wrap rounded p-3"
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex-1 py-2 rounded text-[13px] font-bold"
        ...
        <a
          ...
          className="flex-1 py-2 rounded text-[13px] font-bold text-center"
