  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-caleo-13 mb-4" style={{ fontFamily: 'JetBrains Mono, monospace', color: '#5A6472' }}>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="mb-4">
            <label
              ...
              className="block text-xs font-semibold text-caleo-navy mb-1"
            >
              Ganti paket <span className="font-normal text-caleo-11">(opsional)</span>
            </label>
            <select
              id="renew-plan-code"
              value={newPlanCode}
          ...
          <div className="mb-4">
            <label
              ...
              className="block text-xs font-semibold text-caleo-navy mb-1"
            >
              Catatan internal <span className="font-normal text-caleo-11">(opsional)</span>
            </label>
            <textarea
              id="renew-notes"
              value={notes}
          ...
          >
            ...
            >
              ...
              />
              <span className="text-caleo-13 font-semibold text-caleo-navy">
            ...
            {paymentEnabled && (
              <div className="px-4 pb-4 space-y-4 border-t" style={{ borderColor: '#ECEEF1' }}>
                ...
                <div>
                  ...
                  />
                  {payFileError && (
                    <p className="text-caleo-11 mt-1 text-caleo-danger">{payFileError}</p>
                  )}
