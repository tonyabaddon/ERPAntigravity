    ...
    <div className="space-y-4 font-vosi">
      ...
      <div className="flex justify-between items-center flex-wrap gap-2">
        ...
        <button
          ...
          className="border rounded-xl px-3 py-1.5 text-[12px] font-medium transition-opacity hover:opacity-80 disabled:opacity-40"
      ...
      <div className="flex flex-wrap gap-2 items-end">
        ...
        <label className="flex flex-col gap-0.5">
          ...
          <select
            ...
            className="border rounded-xl px-3 py-1.5 text-[12px] focus:outline-none"
        ...
        <label className="flex flex-col gap-0.5">
          ...
          <div className="flex gap-1 items-center">
            <input
              ...
              className="border rounded-xl px-2 py-1.5 text-[12px] focus:outline-none"
