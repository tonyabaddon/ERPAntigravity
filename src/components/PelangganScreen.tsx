...
export default function PelangganScreen({ openCustomerId, onNavigate, showToast }: PelangganScreenProps) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex bg-white rounded-sm border border-gray-200 overflow-hidden" style={{ minHeight: '520px' }}>

        {/* Left panel */}
        <div className="w-72 shrink-0 border-r border-gray-200 flex flex-col">
          <div className="p-3 border-b border-gray-200 space-y-2">
            <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-sm px-3 py-2">
                ...
                {editing ? (
                  <div className="flex gap-2 shrink-0">
                    <button
                      ...
                      disabled={saving}
                      className="flex items-center gap-1 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-white text-xs font-bold px-2.5 py-1.5 rounded-sm transition-colors"
                    >
                      <Check className="w-3.5 h-3.5" />{saving ? '...' : 'Simpan'}
                    </button>
                    <button
                      onClick={() => setEditing(false)}
                      className="flex items-center gap-1 bg-white/10 hover:bg-white/20 text-white text-xs px-2.5 py-1.5 rounded-sm transition-colors"
                    >
                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 bg-white/10 hover:bg-white/20 text-white text-[10px] px-2 py-1 rounded-sm transition-colors"
                    >
              ...
              <div className="px-4 py-4">
                ...
                {salesEntries.length === 0 ? (
                  ...
                  salesEntries.map(entry => {
                    ...
                    return (
                      <div key={entry.id} className="border border-gray-200 rounded-sm p-3 mb-2 last:mb-0 text-xs">
              ...
              <div className="px-4 py-4 border-t border-gray-100">
                ...
                {profile.leads.length === 0 ? (
                  ...
                  profile.leads.map(lead => {
                    ...
                    return (
                      <div key={lead.id} className="border border-gray-200 rounded-sm p-3 mb-2 last:mb-0 flex justify-between items-center">
                        <div>
