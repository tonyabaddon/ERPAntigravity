        ...
        <div className="flex items-center gap-3 flex-wrap">
          {isOwner && (
            <input
              ...
              className="bg-white border border-[#e5eeff] rounded-sm px-3 py-2 text-xs font-semibold text-[#012749] outline-none focus:ring-1 focus:ring-[#012749]"
            />
          )}
          {isOwner && (
            <button
                ...
                <div key={`tx-${tx.id}`} className="flex items-center gap-3 p-3 rounded-sm border border-slate-100 bg-slate-50/50 hover:bg-blue-50/20 transition-all">
                  ...
                  {isIncome && tx.invoice_number && (
                    <button
                      ...
                      className="p-1.5 rounded-sm hover:bg-slate-100 text-gray-400 hover:text-[#012749] transition-all flex-shrink-0"
                      title="Cetak invoice"
                    >
        ...
        <div className="flex flex-col gap-4">
          ...
          {isOwner && summary && (
            <div className="bg-white rounded-[2.5rem] border border-[#e5eeff] shadow-xl overflow-hidden">
              ...
              <div className="mx-5 mb-5 bg-gradient-to-br from-[#012749] to-[#1e3d60] rounded-sm p-4 text-white">
      ...
      <div className="bg-white rounded-sm shadow-2xl w-full max-w-md overflow-hidden" onClick={e => e.stopPropagation()}>
        ...
        <div className="px-5 py-4 border-t border-slate-100 bg-slate-50/50">
          <button
            onClick={handleSave}
            disabled={!canSave}
            className="w-full py-2.5 rounded-sm text-xs font-bold bg-[#012749] text-white hover:bg-[#1e3d60] transition-all disabled:opacity-50"
          >
