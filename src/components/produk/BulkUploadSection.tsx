    ...
    <section className="bg-white rounded-[2.5rem] p-8 border border-[var(--color-caleo-mist)] shadow-xl hover:shadow-2xl transition-all duration-300">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded bg-blue-50 text-[#1e3d60] flex items-center justify-center shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
        <div
          ...
          className="bg-[var(--color-caleo-cloud)] rounded p-8 border border-transparent hover:border-[#1e3d60]/20 hover:bg-blue-100/40 transition-all cursor-pointer group flex flex-col items-center justify-center text-center select-none"
        >
        ...
        <div
          ...
          className="bg-violet-50 rounded p-8 border border-transparent hover:border-violet-300 hover:bg-violet-100/40 transition-all cursor-pointer group flex flex-col items-center justify-center text-center select-none"
        >
        ...
        <label
          className="rounded p-8 flex flex-col items-center justify-center text-center group cursor-pointer transition-all hover:bg-emerald-500/5 select-none"
      ...
      {uploadProgress !== null && (
        <div className="mt-8 space-y-2 animate-fadeIn bg-slate-50/50 p-4 rounded border border-slate-100">
