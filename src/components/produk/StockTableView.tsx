              ...
              {isEditing && vals && (
                <div className="bg-blue-50 border border-blue-200 border-t-0 rounded-b-2xl p-5">
                  ...
                  <div className="flex justify-end gap-2 pt-4">
                    ...
                    <button type="button" onClick={() => void saveEdit(item.sku)} className="px-5 py-2 bg-[#2d8a4e] text-white rounded-full text-xs font-bold hover:bg-emerald-700 cursor-pointer">Simpan Perubahan</button>
                  </div>
                </div>
              )}
            </div>
