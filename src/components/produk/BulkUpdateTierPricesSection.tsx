  ...
  return (
    <div className="bg-white rounded border border-gray-200 p-6">
      ...
      <div className="flex gap-2">
        <button onClick={handleDownloadTemplate} className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-700 text-xs font-bold rounded hover:bg-slate-200">
          <Download className="w-3.5 h-3.5" /> Download Template
        </button>
        <input ref={fileRef} type="file" accept=".csv" className="hidden" onChange={handleFile} />
        <button onClick={() => fileRef.current?.click()} className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--color-caleo-primary)] text-white text-xs font-bold rounded hover:bg-[#01365e]">
        ...
        <div className="mt-4 border border-slate-200 rounded">
          ...
          <div className="p-3 bg-slate-50 border-t flex items-center justify-between gap-3">
            ...
            <button onClick={handleApply} disabled={!canApply || applying}
              className="ml-auto inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white text-xs font-bold rounded disabled:opacity-50">
