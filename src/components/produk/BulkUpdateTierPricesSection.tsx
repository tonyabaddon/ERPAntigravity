  ...
  return (
    <div className="bg-white rounded-sm border border-gray-200 p-6">
      ...
      <div className="flex gap-2">
        <button onClick={handleDownloadTemplate} className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-700 text-xs font-bold rounded-sm hover:bg-slate-200">
        ...
        <div className="mt-4 border border-slate-200 rounded-sm">
          ...
          <div className="p-3 bg-slate-50 border-t flex items-center justify-between gap-3">
            ...
            <button onClick={handleApply} disabled={!canApply || applying}
              className="ml-auto inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white text-xs font-bold rounded-sm disabled:opacity-50">
