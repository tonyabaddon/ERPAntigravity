      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {filtered.map(item => (
          <button key={item.sku} onClick={() => onEdit(item.sku)}
                  className="text-left bg-slate-50 rounded p-3 border border-slate-100 hover:border-emerald-200 hover:shadow-md transition">
            <div className="aspect-square rounded overflow-hidden bg-slate-200 mb-2">
