        ...
        <div className="p-6 space-y-4 text-[13px]">
          <div>
            ...
            <select
              ...
              disabled={isEdit}
              className="w-full border border-slate-200 rounded-sm px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-caleo-primary)]/30 bg-white disabled:bg-slate-100 disabled:cursor-not-allowed"
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-slate-200 rounded-sm px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-caleo-primary)]/30"
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <NumberInput
                  ...
                  placeholder="0"
                  className="w-full border border-slate-200 rounded-sm px-3 py-2 text-sm text-right focus:outline-none focus:ring-2 focus:ring-[var(--color-caleo-primary)]/30"
                />
