...
function AccountCard({ account, isPersonal = false, onClick }: AccountCardProps) {
  ...
  if (isPersonal) {
    return (
      <div
        className="border border-gray-200 bg-gray-50 rounded-xl p-5 cursor-pointer transition-all hover:shadow-md hover:-translate-y-0.5"
        onClick={onClick}
        role="button"
        tabIndex={0}
      ...
      >
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl flex items-center justify-center bg-gray-200 text-gray-500">
  ...
  return (
    <div
      className="border border-[#c7d7f5] bg-[#fafbff] rounded-xl p-5 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-0.5"
      onClick={onClick}
      role="button"
      tabIndex={0}
      onKeyDown={e => e.key === 'Enter' && onClick()}
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${bgClass} ${textClass}`}>
    ...
    <div className="p-6 max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4 mb-6">
        <div className="flex items-start gap-3">
          <div className="w-11 h-11 rounded-xl bg-[#eff4ff] flex items-center justify-center text-[#012749]">
      ...
      <div className="mb-8">
        ...
        {businessAccounts.length === 0 ? (
          <div className="border border-[#c7d7f5] bg-[#fafbff] rounded-xl p-8 text-center text-[13px] text-gray-500">
      ...
      {accounts.length === 0 && (
        <div className="border border-[#c7d7f5] bg-[#fafbff] rounded-xl p-12 text-center text-[13px] text-gray-500 mt-2">
