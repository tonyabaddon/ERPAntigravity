  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(1,39,73,0.4)' }} onClick={onCancel}>
      <div className="bg-white rounded p-6 w-full max-w-md" onClick={e => e.stopPropagation()}>
        ...
        <label className="block text-caleo-10 font-bold uppercase text-slate-500 mb-1">Bank</label>
        ...
        <label className="block text-caleo-10 font-bold uppercase text-slate-500 mb-1">Nomor Rekening</label>
        ...
        <label className="block text-caleo-10 font-bold uppercase text-slate-500 mb-1">Label</label>
        ...
        <label className="block text-caleo-10 font-bold uppercase text-slate-500 mb-1">Tujuan</label>
