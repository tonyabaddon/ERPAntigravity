      ...
      <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={onClose}>
        ...
        >
            ...
            <div className="bg-white rounded shadow-sm p-7 font-serif text-sm">
              {loading ? (
                ...
                <>
                  ...
                  {/* No-refund notice */}
                  <div className="bg-orange-50 border border-orange-200 rounded px-4 py-2.5 mb-4 font-sans text-xs text-orange-800">
          ...
          <div className="flex justify-end gap-2 px-4 py-3 border-t border-gray-100 print:hidden">
            <button onClick={onClose} className="px-4 py-2 bg-gray-100 text-gray-600 text-xs font-bold rounded hover:bg-gray-200">Tutup</button>
            <button onClick={handlePrint} className="flex items-center gap-1.5 px-4 py-2 bg-[#2d8a4e] text-white text-xs font-bold rounded hover:bg-green-700">
              <Download className="w-3.5 h-3.5" /> Download PDF
            </button>
          </div>
        </div>
