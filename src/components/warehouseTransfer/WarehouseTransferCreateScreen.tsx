    ...
    <div className="p-6 space-y-5 max-w-3xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full rounded border border-slate-200 px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold"
          >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded border border-slate-200 px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold disabled:bg-slate-50 disabled:text-slate-400"
          >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full rounded border border-slate-200 px-3 py-2 text-sm resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold"
        />
      </div>
