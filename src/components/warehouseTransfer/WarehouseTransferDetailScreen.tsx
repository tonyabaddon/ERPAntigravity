                  ...
                  <td className="px-4 py-2 text-right">
                    {isReceiver ? (
                      <NumberInput
                        ...
                        className="w-20 rounded border border-slate-200 px-2 py-1 text-right text-sm tabular-nums focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold"
                      />
                    ) : (
