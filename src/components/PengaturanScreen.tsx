        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="bg-white rounded border border-gray-200 p-6">
            ...
            <div className="flex items-center gap-4">
              <div className="w-20 h-20 bg-slate-50 border-2 border-dashed border-slate-200 rounded flex items-center justify-center overflow-hidden">
                {logoUrl ? (
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--color-caleo-primary)] text-white text-xs font-bold rounded hover:bg-[#01365e] disabled:opacity-60"
                >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {!showAddForm && (
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 bg-emerald-600 text-white text-sm font-semibold rounded hover:bg-emerald-700"
                >
                  ...
                  <div className="border border-gray-200 rounded p-4 bg-gray-50 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          className="w-full border rounded px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2"
                      ...
                      <div>
                        ...
                        <select
                          className="w-full border rounded px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2 bg-white"
                          value={addForm.role}
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        disabled={addSaving}
                        className="flex items-center gap-1.5 px-4 py-2 bg-emerald-600 text-white text-sm font-semibold rounded hover:bg-emerald-700 disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        disabled={addSaving}
                        className="flex items-center gap-1.5 px-4 py-2 bg-gray-100 text-gray-700 text-sm font-semibold rounded hover:bg-gray-200 disabled:opacity-50"
                      >
                        <X className="w-4 h-4" />
                        Batal
                      </button>
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      <div className="flex items-center gap-3 px-2">
        <div className="w-10 h-10 bg-[var(--color-caleo-primary)] rounded flex items-center justify-center shrink-0">
        ...
        {activeTab === 'whatsapp-ai' && (
          <div className="space-y-4 animate-fadeIn">
            ...
            <button
              ...
              className="w-full flex items-center justify-between bg-white rounded border border-gray-200 px-4 py-4 hover:border-indigo-300 hover:shadow-sm transition-all text-left"
            >
              <div>
...
function OwnerPinCard({ showToast }: { showToast: (msg: string, type?: 'success' | 'info' | 'warning') => void }) {
  ...
  if (hasPin === null) {
    return (
      <div className="bg-white rounded border border-gray-200 p-6 text-sm text-gray-500">
        Memuat status PIN…
      </div>
    );
  }
