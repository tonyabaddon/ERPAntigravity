      ...
      <div className="flex-1">
        {isEditing ? (
          <input
            ...
            onBlur={cancelEdit}
            className="w-full bg-white rounded px-2 py-1 border border-slate-300 text-xs font-semibold text-slate-800 outline-none focus:ring-1 focus:ring-[var(--color-caleo-primary)]"
          />
        ) : (
          <button
            type="button"
