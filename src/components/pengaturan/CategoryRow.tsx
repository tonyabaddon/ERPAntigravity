      ...
      <div className="flex-1">
        {isEditing ? (
          <input
            ...
            onBlur={cancelEdit}
            className="w-full bg-white rounded px-2 py-1 border border-slate-300 text-xs font-semibold text-slate-800 outline-none focus-visible:ring-1 focus-visible:ring-caleo-gold"
          />
        ) : (
          <button
            type="button"
