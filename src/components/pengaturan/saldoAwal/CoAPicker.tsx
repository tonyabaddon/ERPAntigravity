    ...
    <div ref={containerRef} className="relative">
      <div className="flex items-center gap-1">
        <input
          ...
          disabled={disabled}
          className="w-full border border-slate-200 rounded-lg px-3 py-1.5 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#012749]/30 disabled:bg-slate-50 disabled:cursor-not-allowed"
        />
        {value && !disabled && (
          <button
            type="button"
