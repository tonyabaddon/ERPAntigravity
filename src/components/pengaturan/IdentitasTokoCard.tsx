  ...
  return (
    <div className="bg-white rounded-sm border border-[#e5eeff] p-6 shadow-sm">
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          <h3 className="text-base font-extrabold text-[var(--color-caleo-primary)]">Identitas Toko</h3>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                rows={2}
                className="w-full border border-slate-200 rounded-sm px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-caleo-primary)]/30 resize-none"
