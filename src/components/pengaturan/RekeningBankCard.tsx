  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <>
          {showForm && (
            <div className="border border-[var(--color-caleo-mist-dark)] bg-[#fafbff] rounded p-4 mb-4">
              ...
              {accounts.map(account => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-[var(--color-caleo-primary)] hover:bg-[var(--color-caleo-cloud)] p-2 rounded disabled:opacity-30"
                    title="Edit"
                  >
                    <Edit2 size={16} />
                  </button>
