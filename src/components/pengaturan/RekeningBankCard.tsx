  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <>
          {showForm && (
            <div className="border border-[#c7d7f5] bg-[#fafbff] rounded-xl p-4 mb-4">
              ...
              {accounts.map(account => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-[#012749] hover:bg-[#eff4ff] p-2 rounded-lg disabled:opacity-30"
                    title="Edit"
                  >
                    <Edit2 size={16} />
                  </button>
                  <button
                    ...
                    disabled={busyId === account.id}
                    className="text-red-600 hover:bg-red-50 p-2 rounded-lg disabled:opacity-30"
                    title="Hapus"
                  >
                    <Trash2 size={16} />
                  </button>
