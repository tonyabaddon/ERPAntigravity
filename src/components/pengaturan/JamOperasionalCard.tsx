              ...
              >
                ...
                <div className="flex-1 flex items-center gap-2 justify-end">
                  <input
                    ...
                    className="border border-slate-200 rounded px-2 py-1.5 text-sm font-mono disabled:bg-slate-100 disabled:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2"
                  />
