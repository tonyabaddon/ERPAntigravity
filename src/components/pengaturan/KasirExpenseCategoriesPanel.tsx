  ...
  if (isError) return (
    <div className="p-6 space-y-2">
      ...
      <button
        type="button"
        onClick={() => refetch?.()}
        className="px-3 py-1.5 rounded-sm bg-[#012749] text-white text-xs font-bold"
      >
        Coba lagi
      </button>
    </div>
      ...
      <div className="px-6 py-5 border-b border-slate-100">
        ...
        {isEditable && addingLabel === null && (
          <button
            ...
            className="mt-4 inline-flex items-center gap-1 bg-[#012749] text-white rounded-sm px-4 py-2 text-xs font-bold hover:bg-[#1e3d60]"
          >
      ...
      {isEditable && addingLabel !== null && (
        <div className="flex items-center gap-3 px-4 py-3 border-t border-slate-100 bg-slate-50">
          <input
            ...
            className="flex-1 bg-white rounded-sm px-2 py-1 border border-slate-300 text-xs font-semibold text-slate-800 outline-none focus:ring-1 focus:ring-[#012749]"
          />
          <button
            type="button"
