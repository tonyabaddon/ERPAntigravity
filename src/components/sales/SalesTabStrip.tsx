...
export function SalesTabStrip({ activeCount }: Props) {
  return (
    <div className="flex items-end gap-1 border-b mb-5" style={{ borderColor: '#e5eeff' }}>
      ...
      <button onClick={() => navigate('daftarPesanan')} className="px-4 py-3 text-sm font-bold transition flex items-center gap-2" style={{ color: 'var(--color-primary)', borderBottom: '3px solid var(--color-primary)', background: 'transparent', marginBottom: '-1px' }}>
        📦 Daftar Pesanan
