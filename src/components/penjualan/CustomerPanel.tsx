    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-10 pr-3 py-2.5 text-sm border rounded-lg outline-none ${
            isSelected
        ...
        <div className="mt-2 bg-[#012749]/5 border border-[#012749]/30 rounded-xl px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            <button
              ...
              className="text-[#012749] text-[11px] font-bold bg-white px-3 py-1 rounded-lg border border-[#012749]/30 hover:bg-[#012749]/5 flex items-center gap-1"
            >
