  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4 md:p-6">
                        ...
                        <div className="mt-4 space-y-4 bg-slate-50 rounded p-4">
                          ...
                          <label className="block">
                            ...
                            <input
                              ...
                              className="px-3 py-2 border border-slate-300 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold"
                            />
                          </label>
                          ...
                          <label className="block">
                            ...
                            <textarea
                              ...
                              className="w-full px-3 py-2 border border-slate-300 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold text-sm"
                            />
                          </label>
          ...
          <div className="px-6 py-3 border-t border-slate-200 bg-slate-50 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-2 text-sm font-semibold rounded text-slate-700 border border-slate-300 hover:bg-slate-100 disabled:opacity-40 disabled:cursor-not-allowed"
              >
                ← Kembali
              </button>
              {currentStep < 3 && (
                <button
                  ...
                  className="px-4 py-2 text-sm font-bold rounded bg-[var(--color-caleo-primary)] text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      {pendingApprovalId !== null && !reasonPromptOpen && (
        <div className="fixed bottom-4 right-4 z-40 max-w-sm rounded border border-blue-200 bg-blue-50 p-4 shadow-lg" style={{ fontSize: '14px' }}>
