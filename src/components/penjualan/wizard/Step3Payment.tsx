        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="0"
              className="w-full text-right px-3 py-2 text-sm border border-slate-300 rounded outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2 focus:border-[var(--color-caleo-primary)] disabled:bg-slate-100 disabled:text-slate-400"
            />
          </div>
