...
export default function NewCustomerInlineForm({ onSaved, onCancel, showToast, showTierField = false, tenantSettings }: Props) {
  ...
  return (
    <div data-testid="new-customer-form" className="mt-3 border-2 border-[var(--color-caleo-primary)]/30 rounded p-4 bg-[var(--color-caleo-primary)]/5">
      ...
      <div className="mt-3 flex justify-end gap-2">
        <button type="button" onClick={onCancel} disabled={submitting} className="px-3 py-1.5 text-xs font-semibold rounded text-slate-600 hover:bg-slate-100 disabled:opacity-50">Batal</button>
        <button type="button" onClick={onSubmit} disabled={!canSubmit} className="px-4 py-1.5 text-xs font-bold rounded bg-[var(--color-caleo-primary)] text-white hover:opacity-90 disabled:opacity-50">
