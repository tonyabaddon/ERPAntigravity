  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6">
      ...
      <div className="lg:col-span-5 space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 text-sm border border-slate-300 rounded outline-none focus:ring-2 focus:ring-[var(--color-caleo-primary)]/30 focus:border-[var(--color-caleo-primary)]"
          />
        </div>
      ...
      <div className="lg:col-span-7">
        ...
        {(skuCount > 0 || jasaCount > 0) && (
          <div className="mt-3 bg-slate-50 rounded p-4 space-y-1.5">
