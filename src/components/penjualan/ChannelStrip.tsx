  ...
  return (
    <div className="bg-gradient-to-r from-amber-100 to-amber-50 border border-amber-300 border-l-4 border-l-amber-600 rounded px-4 py-3 mb-4 flex items-center gap-3">
      ...
      <input
        ...
        className="bg-white border border-amber-300 rounded px-3 py-2 text-[13px] font-bold text-amber-900 min-w-[220px]"
      />
    </div>
  );
}
      ...
      <div className="flex-1">
        ...
        <div className="grid grid-cols-[1fr_1.4fr] gap-2">
          <input
            ...
            className="bg-white border border-green-300 rounded px-3 py-2 text-[13px] font-bold text-green-900"
          />
          <input
            value={chatUrl}
