                ...
                <>
                  <div>
                    ...
                    <NumberInput
                      ...
                      allowDecimal={false}
                      className="w-32 border border-slate-200 rounded px-3 py-2 text-right text-[13px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2"
                    />
                  </div>
