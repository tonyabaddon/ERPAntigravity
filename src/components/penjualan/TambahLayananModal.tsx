                ...
                <>
                  <div>
                    ...
                    <NumberInput
                      ...
                      allowDecimal={false}
                      className="w-32 border border-slate-200 rounded px-3 py-2 text-right text-caleo-13 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold focus-visible:ring-offset-2"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <div className="text-caleo-11 text-slate-400 mt-1">
                      Default catalog:{' '}
                  ...
                  <div className="border border-slate-200 rounded bg-slate-50 p-3 text-xs">
