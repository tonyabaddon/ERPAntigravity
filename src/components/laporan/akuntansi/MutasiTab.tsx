    ...
    <div className="rounded border border-[var(--color-caleo-mist-dark)] bg-white overflow-hidden">
      ...
      <div className="p-6 grid grid-cols-12 gap-3 text-[12px]">
        ...
        <div className="col-span-3">
          ...
          <select
            className="w-full border border-[var(--color-caleo-mist-dark)] rounded px-3 py-1.5 text-xs bg-white text-[#43474e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold"
            value={periodPreset}
