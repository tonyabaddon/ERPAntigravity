    ...
    <div className="rounded border border-[var(--color-caleo-mist-dark)] bg-white overflow-hidden">
      ...
      <div className="px-6 pt-4 pb-2 flex items-center gap-3 border-b border-gray-100">
        ...
        <input
          ...
          className="text-[12px] border border-[var(--color-caleo-mist-dark)] rounded px-3 py-1.5 text-[#1e3d60] font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-caleo-gold"
        />
      ...
      <div className="p-6">
        {loading ? (
          ...
          <>
            ...
            <div
              className="mt-6 rounded p-3 flex items-center gap-2 text-[11px] text-amber-900 border"
