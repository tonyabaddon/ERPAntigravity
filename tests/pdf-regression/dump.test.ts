...
const storeSettings = {
  ...
  nama_legal: 'PT Sinar Elektrik',
  tagline: 'Electrical Panel & Engineering',
  alamat_lengkap: 'Jl. Sudirman No. 1',
  kota: 'Surabaya',
  telp_wa: '081234567890',
  telp_kantor: '031-5551234',
  email: 'sales@sinarelektrik.co.id',
  website_url: 'https://sinarelektrik.co.id',
...
describe('10 salesOrderPdf', () => {
  test('generateSalesOrderPdf', async () => {
    ...
    const so = {
      ...
      items: [
        {
          sku: null, name: 'PANEL INDOOR 300A', qty: 1,
          unit_price: 15_000_000, hpp_per_unit: 12_000_000,
          subtotal: 15_000_000, hpp_subtotal: 12_000_000, warehouse: null,
          brand_name: 'Schneider',
          sub_parts: [
            { name: 'Box Panel Indoor Plat 1.2 mm' },
            { name: 'MCCB 3P 300A' },
            { name: 'Pilot Lamp RST' },
            { name: 'Terminal, Busbar, Rail & Duct' },
            { name: 'Pemasangan' },
          ],
        },
        {
          sku: null, name: 'PILOT LAMP RST', qty: 3,
          unit_price: 150_000, hpp_per_unit: 100_000,
          subtotal: 450_000, hpp_subtotal: 300_000, warehouse: null,
          brand_name: 'Chint',
        },
        {
          sku: null, name: 'MCB 1P 16A', qty: 6,
          unit_price: 45_000, hpp_per_unit: 30_000,
          subtotal: 270_000, hpp_subtotal: 180_000, warehouse: null,
          brand_name: 'Schneider',
        },
      ],
      subtotal: 15_720_000,
