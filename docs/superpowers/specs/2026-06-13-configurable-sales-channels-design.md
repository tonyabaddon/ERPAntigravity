...
| D11 | ~~Walk-in locked (tidak bisa di-hide)~~ **REVOKED 2026-06-13**: admin bisa toggle SEMUA 14 channel termasuk Walk-in. CHANNEL_LOCKED = empty Set. Kalau admin disable semua channel, form input kosong — admin trusted untuk leave at least one active. | Founder feedback: kunci permanen terlalu rigid; founder bisa restructure bisnis tanpa Walk-in (mis. 100% online) |
